...
extern void qpnp_chg_pwrkey_press(void);
int qpnp_pon_is_pwrkey_press(void)
{
	struct qpnp_pon *pon = sys_reset_dev;
	int rc;
	u8 pon_rt_sts = 0;
...
EXPORT_SYMBOL(qpnp_pon_is_pwrkey_press);
#endif
...
static int qpnp_pon_suspend(struct spmi_device *dev, pm_message_t pmesg)
{
	return 0;
}
